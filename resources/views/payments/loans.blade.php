<div class="container">
    <div class="row">
      <div class="col-md-3">
        <p><strong class="text-muted">Balance:</strong> <strong class="text-danger" id="paybal">{{number_format($loan->balance,2)}}</strong></p>
      </div>
      <div class="col-md-7">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="date" name="date" id="date" value="{{date('Y-m-d')}}" min="{{date('Y-m-d',strtotime($loan->loan_date))}}" max="{{date('Y-m-d')}}" required class="form-control">
          </div>
        </div>
